...
Одна внутренняя платформа для руководителей и сотрудников производственных подразделений:

- канбан (общая доска и доски по системам);
- график смен с автозаполнением;
- кадровый справочник, экзамены/пропуска, архив уволенных;
- аналитика по задачам;
- база знаний, личные заметки, справочник УСПД;
- роли и права, аудит, резервные копии БД.
